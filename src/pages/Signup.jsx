...
function Signup() {
  ...
  // Updated state to include username
...
toast.success("Account created successfully 🎉");
  ...
  return (
    // Modified Animation - Smooth Page Fade + Slide Entrance & Exit for AnimatePresence
    <motion.div
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -top-40 -right-40 w-96 h-96 rounded-full bg-fuchsia-600/25 blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, 30, 0],
        ...
        className="pointer-events-none absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-violet-600/20 blur-3xl"
      />
      <motion.div
        animate={{
          scale: [1, 1.15, 1],
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Animation Added - Name Field Hover & Stagger Item */}
              ...
              {/* Animation Added - Username Field Hover & Stagger Item */}
              <motion.div variants={itemVariants}>
                <motion.label
                  whileHover={{ scale: 1.01, borderColor: "rgba(255, 255, 255, 0.2)" }}
                  transition={{ duration: 0.2 }}
